...
<p>Também tive problemas para colocar o meu banco de dados postgres na nuvem de forma gratuita, consegui localizar alguns sites que tem esse serviço mas depois de testar percebi que tinha lentidão no meu front, então decidi utilizar o Railway que na forma gratuiuta me disponibiliza 200horas para deixar meu banco de dados na nuvem, estou pesquisando para encontrar uma solução gratuita que mantenha minha aplicação por mais tempo.</p>
